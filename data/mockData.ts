...
export const PRODUCTS_DATA: Product[] = [
  ...
  {
    id: "prod-3",
    name: "Sophia Silk Touch Workwear Blouse - Off White",
    category: "Tops & Shirts",
    originalPrice: 9490,
    discountedPrice: 7490,
    rating: 4.9,
    reviewCount: 34,
    primaryImage: "https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?w=800&q=80",
    hoverImage: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=800&q=80",
    galleryImages: [
      "https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?w=1200&q=85",
      "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=1200&q=85",
    ...
    colors: [
      ...
      { name: "Dusty Rose", hex: "#DCAE96", bgClass: "bg-rose-300" },
    ],
    inStock: true,
    isBestseller: true,
    description: "Effortlessly elegant workwear blouse styled with a tailored split neckline, concealed mother-of-pearl front buttons, and fluid drape crafted for corporate settings.",
    fabricCare: [
      "Silk Touch Poly Crepe",
...
export const REVIEWS_DATA: Review[] = [
  ...
  },
  {
    ...
    location: "Galle",
    rating: 5,
    title: "Exceptional Workwear Blouse",
    comment: "The Sophia silk blouse is super breathable for Colombo weather. Fits true to size and delivery to Galle was completely smooth.",
    verifiedBuyer: true,
    purchasedItem: "Sophia Silk Touch Workwear Blouse",
    date: "2 weeks ago",
  },
  {
    id: "rev-4",
