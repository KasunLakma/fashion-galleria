...
export const PRODUCTS_DATA: Product[] = [
  ...
  {
    id: "prod-3",
    name: "Elegance Workwear Blazer",
    category: "Tops & Shirts",
    originalPrice: 15990,
    discountedPrice: 12990,
    rating: 4.9,
    reviewCount: 34,
    primaryImage: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=800&q=80",
    hoverImage: "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?auto=format&fit=crop&w=800&q=80",
    galleryImages: [
      "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=1200&q=85",
      "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?w=1200&q=85",
    ],
    tag: "WORKWEAR",
    ...
    outOfStockSizes: [],
    colors: [
      { name: "Classic Black", hex: "#000000", bgClass: "bg-black" },
      { name: "Cream Off-White", hex: "#FAFAFA", bgClass: "bg-stone-100 border border-gray-300" },
    ],
    inStock: true,
    isBestseller: true,
    description: "Sleek and empowering, the Elegance Workwear Blazer offers a tailored fit with notched lapels and soft inner lining. Designed for corporate executives seeking effortless sophistication in Sri Lanka.",
    fabricCare: [
      "Premium Stretch Poly-Blend",
  ...
  {
    id: "prod-8",
    name: "Isabella Riviera Resort Linen Maxi Dress",
    category: "Dresses",
    originalPrice: 12990,
    ...
    colors: [
      ...
      { name: "Cream White", hex: "#FAFAFA", bgClass: "bg-stone-100 border border-gray-300" },
    ],
    inStock: true,
    isNewArrival: true,
    description: "Relaxed resort maxi dress detailed with tier ruffle hemline and lightweight breathable linen weave, ideal for coastal weekend getaways.",
    fabricCare: [
      "100% Organic Linen",
      "Hand wash cold",
    ],
...
export const REVIEWS_DATA: Review[] = [
  ...
  },
  {
    ...
    location: "Galle",
    rating: 5,
    title: "Exceptional Elegance Blazer",
    comment: "The Elegance Workwear Blazer is super breathable for Colombo weather. Fits true to size and delivery to Galle was completely smooth.",
    verifiedBuyer: true,
    purchasedItem: "Elegance Workwear Blazer",
    date: "2 weeks ago",
  },
  {
    id: "rev-4",
